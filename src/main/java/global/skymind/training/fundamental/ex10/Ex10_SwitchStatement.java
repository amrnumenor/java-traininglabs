 ...
 */
package global.skymind.training.fundamental.ex10;
...
//        ifElseStatement(/* ENTER YOUR CODE HERE */); // comment out if not used

//        inefficientSwitchStatement(/* ENTER YOUR CODE HERE */); // comment out if not used

//        efficientSwitchStatement(/* ENTER YOUR CODE HERE */); //comment out if not used
