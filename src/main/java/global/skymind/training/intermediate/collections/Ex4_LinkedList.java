...
public class Ex4_LinkedList{
    ...
    public void insertFirstLink(String bookName, int millionsSold){
        Ex4_Linked newLink = new Ex4_Linked(bookName, millionsSold);
        // Connects the firstLink field to the new Link
        newLink.next = firstLink;
        firstLink = newLink;
    }

    public Ex4_Linked removeFirst(){
        Ex4_Linked linkReference = firstLink;
        if(!isEmpty()){
    ...
    public Ex4_Linked find(String bookName){
        Ex4_Linked theLink = firstLink;
        if(!isEmpty()){
    ...
    public Ex4_Linked removeLink(String bookName){
        Ex4_Linked currentLink = firstLink;
        Ex4_Linked previousLink = firstLink;
